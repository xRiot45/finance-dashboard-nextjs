...
export function CategoriesPagination({ currentPage, onPageChange, pageCount, totalCount }: CategoriesPaginationProps) {
    ...
    return (
        <div className="flex flex-col gap-3 border-t border-border/70 pt-4 md:flex-row md:items-center md:justify-between">
            <p className="text-sm text-muted-foreground">{formatNumber(totalCount)} categories</p>
